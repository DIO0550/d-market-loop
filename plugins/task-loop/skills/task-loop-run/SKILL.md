...
1. タスクファイルの Description、Requirements、Files to Modify、Test Cases、Acceptance Criteria を読む
...
3. タスクファイルに Test Cases が指定されている場合:
   - 列挙されたユースケース（正常系・異常系・境界値）を網羅するテストコードを作成する
   - テスト通過＝実装完了として扱う
